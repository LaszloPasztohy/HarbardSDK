...
namespace Harbard
{
	namespace Api
	{
		public class Event : AJsonSerializable
		{
			...
			{
				EventEmergencyLane obj = new EventEmergencyLane();
			...
			{
				EventForbiddenZone obj = new EventForbiddenZone();
			...
			{
				EventRedStop obj = new EventRedStop();
			...
			{
				EventStoppedObject obj = new EventStoppedObject();
			...
			{
				EventStopViolation obj = new EventStopViolation();
			...
			{
				EventTrafficLine obj = new EventTrafficLine();
			...
			{
				EventWhiteLineViolation obj = new EventWhiteLineViolation();
			...
			{
				EventWrongTurn obj = new EventWrongTurn();
			...
			{
				EventWrongWay obj = new EventWrongWay();
